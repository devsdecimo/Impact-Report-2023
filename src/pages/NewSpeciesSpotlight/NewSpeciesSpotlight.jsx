    ...
    <PageContainer>
      ...
      >
        <div className="intro-text">
          <p>
            Researchers identified these species — found on R/V <em>Falkor</em> — as new
            to science and published their findings this year.
          </p>
        </div>
        <div className="content">
          ...
          <Section
            ...
            subtitle="Sponge"
            text="These carnivorous sponges are known for their unique feeding structures and predatory behavior. This species is similar to Abssocladia falkor, but lacks features used for protection called microspheres and microstronglyes."
