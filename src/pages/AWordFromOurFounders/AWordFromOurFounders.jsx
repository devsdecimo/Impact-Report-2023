    ...
    >
      ...
      <div className="content">
        <div className="paragraph">
          ...
          <p>
          As our planet’s final frontier continues to fill us with wonder, the lesson we’ve taken from this first year will guide us for all the rest: the more we seek, the more we find. And, to quote <em>The Neverending Story</em>, having a luck dragon is the only way to go on a quest! 
          </p>
          <p><em>Eric & Wendy Schmidt</em></p>
        </div>
      </div>
