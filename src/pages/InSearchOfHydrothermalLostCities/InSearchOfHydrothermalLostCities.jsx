        ...
        <SectionWithImage
         ...
         <div className='paragraph'>
            ...
            <ul>
                ...
                <li>Demonstrate the effectiveness of using a combination of technologies — such as multibeam sonar from Falkor (too) and AUVs — to rapidly locate and characterize hydrothermal vents</li>
            </ul>
         </div>
         <div className='paragraph'>
         <h3>Resulting highlights:</h3>
            <ul>
                <li>The first research expedition on board R/V Falkor (too) found high-temperature hydrothermal vent fields present at all three study areas, including Puy des Folles, which was previously thought to be inactive. </li>
