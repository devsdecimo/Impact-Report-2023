        ...
        <div className="d-flex">
            ...
            <div className="text-conta5iner">
                ...
                <IconWithText  
                    className={'CTA'} 
                    icon={Map} 
                    text={<a href="https://api.maptiler.com/maps/3dc91cd0-8f83-474a-bc3e-7ead4e7f322e/?key=egFVe2SmC2zBUYnGILbj#3.46/10.75/-101.25" target="_blank" rel="noopener noreferrer">Ship Track</a>} 
                    opacity={1}
                />
                </div>
            </div>
